...
public class Main extends javax.swing.JFrame {
    ...
    private void botonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIniciarSesionActionPerformed
        ...
        if (db != null) {
            ...
            if (usuarios.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Usted no tiene permitido hacer modificaciones en los roles de los usuarios");
            } else if (usuarios.get(USER).isRolCreateRole() == true) {
